    ...
    <section class="flex flex-col mb-0 border-0">
      ...
      <div class="bg-[#f7f9fb] dark:bg-[#7a8d63] py-10 dark:text-white">
        ...
        >
          ...
          >
            <img
              src="public/images/recipe-pic-brown-rice.jpg"
          ...
          >
            <img
              src="public/images/recipe-pic-tacos-Mexican.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-Borage-flower.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-Indian-Rice-Nuts.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-Lentil-burger.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-Chocolate-cake-bundt.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-1401-04.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
          ...
          >
            <img
              src="public/images/recipe-pic-1401-05.jpg"
              class="min-w-80 min-h-72 cursor-pointer hover:opacity-50"
              alt=""
            />
            <p class="text-[#ff0000] text-lg font-extralight my-5 mx-4">
    ...
    <section>
      ...
      >
        ...
        <a href="#">
          ...
          >
            <img
              src="public/images/icons8-aparat-48.png"
              class="aparat-gray"
              alt=""
            />
            <img
              src="public/images/icons8-aparat-48-pink.png"
              class="aparat-pink"
              alt=""
            />
          </div>
      ...
      <div class="container max-w-[700px] flex flex-col md:flex-row mx-auto">
        ...
        <div class="w-full md:w-1/4 footer-box flex flex-col p-4 text-sm">
          <img
            ...
            src="public/images/footer-icon1.png"
            alt=""
          />
          <div>
            <span
        ...
        <div class="w-full md:w-1/4 footer-box flex flex-col p-4">
          <img
            class="w-32 h-24 mx-auto"
            src="public/images/footer-icon4.png"
            alt=""
          />
          <div>
            <span
        ...
        <div class="w-full md:w-1/4 footer-box flex flex-col p-4">
          <img
            class="w-32 h-24 mx-auto"
            src="public/images/footer-icon3.png"
            alt=""
          />
          <div>
            <span
        ...
        <div class="w-full md:w-1/4 footer-box flex flex-col p-4">
          <img
            class="w-32 h-24 mx-auto"
            src="public/images/footer-icon2.png"
            alt=""
          />
          <div>
            <span
  ...
  <!-- header -->
        ...
        >
          ...
          <div class="md:w-1/2 flex justify-center items-center">
            <img
              ...
              src="public/images/tea-pic1.png"
              alt=""
              data-aos="fade-down"
            />
          </div>
    ...
    <section>
      <div class="">
        <div class="bg-[#E9D69F] pb-5">
          <img
            src="public/images/image2-new-1.jpg"
    ...
    <section>
      <div class="">
        <div class="bg-[#E9D69F] pb-5">
          <img
            src="public/images/image3-new.jpg"
            class="mx-auto w-full h-[221px] md:h-[500px]"
            alt=""
          />
        </div>
    ...
    <section>
      <div class="">
        <div class="bg-[#E9D69F] pb-5">
          <img
            src="public/images/image4-new.jpg"
            class="mx-auto w-full h-[221px] md:h-[500px]"
            alt=""
          />
        </div>
        ...
        <div class="">
          <div class="z-20 relative w-96">
            <img
              ...
              src="./public/images/csr-pic1.jpg"
              alt=""
            />
          </div>
        </div>
